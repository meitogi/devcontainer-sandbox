...
| Project rules | `<project>/CLAUDE.md` symlink | `claude-switch local` / `local-proxy` repoints to `CLAUDE-local-dev.md` (which "Read also: CLAUDE-dev.md" for baseline) ; `claude-switch cloud` restores from `tmp/configured/claude-mode` |
